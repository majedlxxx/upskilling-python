...
### Option 1: WSL/Ubuntu/Linux (Preferred)
* Open source IDE: Text editor / where we  our codes eg: visual Studio code..
...
* IDE: Text editor / where we  our codes eg: visual Studio code.
...
* [git-scm](https://git-scm.com/https://git-scm.com/) this tools comes with a cli terminal similar to Linux's CLI.
* IDE: Text editor / where we  our codes eg: visual studio code.
